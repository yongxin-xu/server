...
if(WIN32)
  ...
  if(WITH_ROCKSDB_JEMALLOC)
    ...
    SET_PACKAGE_PROPERTIES(JeMalloc PROPERTIES
      ...
      PURPOSE "Use the JeMalloc Memory Allocator in RocksDB"
      TYPE REQUIRED
    )
...
if(LZ4_FOUND AND (NOT WITH_ROCKSDB_LZ4 STREQUAL "OFF"))
  ...
  add_feature_info(ROCKSDB_LZ4 "ON" "LZ4 Compression in the RocksDB storage engine")
else()
  add_feature_info(ROCKSDB_LZ4 "OFF" "LZ4 Compression in the RocksDB storage engine")
endif()
...
if(BZIP2_FOUND AND (NOT WITH_ROCKSDB_BZIP2 STREQUAL "OFF"))
  ...
  add_feature_info(ROCKSDB_BZIP2 "ON" "BZIP2 Compression in the RocksDB storage engine")
else()
  add_feature_info(ROCKSDB_BZIP2 "OFF" "BZIP2 Compression in the RocksDB storage engine")
endif()
...
if(SNAPPY_FOUND  AND (NOT WITH_ROCKSDB_SNAPPY STREQUAL "OFF"))
  ...
  add_feature_info(ROCKSDB_SNAPPY "ON" "Snappy Compression in the RocksDB storage engine")
else()
  add_feature_info(ROCKSDB_SNAPPY "OFF" "Snappy Compression in the RocksDB storage engine")
endif()
...
if(ZSTD_FOUND AND (NOT WITH_ROCKSDB_ZSTD STREQUAL "OFF"))
  ...
  if (ZSTD_VALID)
    ...
    add_feature_info(ROCKSDB_ZSTD "ON" "Zstandard Compression in the RocksDB storage engine")
  else()
    add_feature_info(ROCKSDB_ZSTD "OFF" "Zstandard Compression in the RocksDB storage engine")
  endif()
else()
  add_feature_info(ROCKSDB_ZSTD "OFF" "Zstandard Compression in the RocksDB storage engine")
endif()
