...
IF(WITH_INNODB_AHI)
  ...
  add_feature_info(INNODB_AHI "ON" "InnoDB Adaptive Hash Index")
  add_feature_info(INNODB_ROOT_GUESS "ON" "Cache index root block descriptors in InnoDB")
  IF(NOT WITH_INNODB_ROOT_GUESS)
    MESSAGE(WARNING "WITH_INNODB_AHI implies WITH_INNODB_ROOT_GUESS")
  ENDIF()
ELSEIF(WITH_INNODB_ROOT_GUESS)
  add_feature_info(INNODB_AHI "OFF" "InnoDB Adaptive Hash Index")
  add_feature_info(INNODB_ROOT_GUESS "ON" "Cache index root block descriptors in InnoDB")
  ADD_DEFINITIONS(-DBTR_CUR_ADAPT)
ELSE()
  add_feature_info(INNODB_AHI "OFF" "InnoDB Adaptive Hash Index")
  add_feature_info(INNODB_ROOT_GUESS "OFF" "Cache index root block descriptors in InnoDB")
ENDIF()
