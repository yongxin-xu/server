...
MACRO (MYSQL_CHECK_LZMA)
  IF (WITH_INNODB_LZMA STREQUAL "ON" OR WITH_INNODB_LZMA STREQUAL "AUTO")
    ...
    IF (HAVE_LZMA_DECODE AND HAVE_LZMA_ENCODE AND HAVE_LZMA_H)
      ...
      LINK_LIBRARIES(lzma) 
      add_feature_info(INNODB_LZMA "ON" "LZMA compression in the InnoDB storage engine")
    ELSE()
      IF (WITH_INNODB_LZMA STREQUAL "ON")
	MESSAGE(FATAL_ERROR "Required lzma library is not found")
      ENDIF()
      add_feature_info(INNODB_LZO "OFF" "LZMA compression in the InnoDB storage engine")
    ENDIF()
  ELSE()
    add_feature_info(INNODB_LZMA "OFF" "LZMA compression in the InnoDB storage engine")
  ENDIF()
ENDMACRO()
